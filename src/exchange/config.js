...
export const SIZE_SETS = {
  ...
  'girls-bottoms': [
    ...
    { group: 'Girls Plus', sizes: [
      n('8.5', '8½ Plus'), n('10.5', '10½ Plus'), n('12.5', '12½ Plus'),
      n('14.5', '14½ Plus'), n('16.5', '16½ Plus'),
    ] },
    { group: 'Juniors', sizes: [
  ...
  'boys-bottoms': [
    ...
    { group: 'Boys Slim', sizes: [
      n('8S', '8 Slim'), n('10S', '10 Slim'), n('12S', '12 Slim'),
      n('14S', '14 Slim'), n('16S', '16 Slim'), n('18S', '18 Slim'), n('20S', '20 Slim'),
    ] },
    { group: 'Boys Husky', sizes: [
      n('10H', '10 Husky'), n('12H', '12 Husky'), n('14H', '14 Husky'),
      n('16H', '16 Husky'), n('18H', '18 Husky'), n('20H', '20 Husky'),
    ] },
