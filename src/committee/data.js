...
export const COMMITTEES = [
  ...
  },
  {
    ...
    when: 'Planned in September, happens late October',
    commitment: 'One afternoon, plus a few weeks of wrangling',
    what: 'Replaced the Fall Festival. Each house takes a section of the lot, decorates cars, and hands out candy while the students trunk or treat. RCAP provides the bags.',
    does: [
      'Lay out the house sections and claim the lot',
      'Get a lead in every house, all four',
      'Sort candy and bags, and set up the day of',
    ],
    who: 'For people who like a short, loud, visible win.',
    note: 'The chair seat is open. Last year one house ended up without a representative, so the first job is making sure all four are covered from the start.',
  },
  {
    id: 'taw',
  ...
  },
  {
    ...
    what: 'New this year. One chair and a team of three or four on content, photo, and video. It runs the RCAP Instagram, the parent newsletter, and goes live from House Cheers on Fridays.',
    does: [
