  ...
  if (step === 'form') {
    return (
      <div className="carpool-shell">
        ...
        <h1 className="cp-h1">RCAP <span className="cp-hl">Carpool.</span></h1>
        {/* Mose's own wording (2026-07-21). Framing is deliberate: the entry
            was reading like an RCA program you enroll in, when it is a tool
            some parents built that you can take or leave. "parent-built",
            "completely optional", and "decide if carpooling is a good fit"
