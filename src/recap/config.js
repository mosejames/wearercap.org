...
export const ROUNDS = [
  {
    ...
    intro:
      'A room full of RCA families, cards down, somebody about to shout. Tell us how it felt with one word or a quick note. Photos go in the RCAP Capsule. Takes about thirty seconds.',
  },
  {
    slug: 'esp-2026',
    name: 'Summer EXP',
